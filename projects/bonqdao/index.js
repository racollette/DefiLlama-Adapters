...
const BEUR_DAI_POOL = [
    '0x338Eb4d394a4327E5dB80d08628fa56EA2FD4B81', // token 0 = BEUR
...
const USDC_BEUR_POOL = [
    ...
    '0x338Eb4d394a4327E5dB80d08628fa56EA2FD4B81'  // token 1 = BEUR
]

async function getPairTVL(balances, contract, pair, collateralFraction, api) {
    ...
    underlying.forEach((e, index) => {
        return sdk.util.sumSingleBalance(balances, pair[index], e * collateralFraction, api.chain);
    })
}
...
module.exports = {
    ...
    methodology: 'Summation of the collateral deposited in each of BonqDAOs lending vaults',
    start: 36884903,
    polygon: {
        tvl,
    }
